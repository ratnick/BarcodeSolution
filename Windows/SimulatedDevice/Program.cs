    ...
    class Program
    {
        ...
        private static void SendDeviceToCloudHttpFunctionRequest()
        {
            var telemetryDataPoint = new
                ...
                BlobPath = THIS_DEVICE_NAME,
                BlobName = FIXED_BLOB_NAME,
                BlobSize = 9567,
                WiFiconnects = 1,
                ESPmemory = 7824,
                Counter = 1
        ...
        static void Main(string[] args)
        {
            while (true)
            {
                ...
                deviceClient = DeviceClient.Create(IOTHUB_HOSTNAME, new DeviceAuthenticationWithRegistrySymmetricKey(THIS_DEVICE_NAME, THIS_DEVICE_SAS));
                SendToBlobAsync(FIXED_BLOB_NAME);
